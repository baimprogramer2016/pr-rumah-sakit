...
<div class="row">
    ...
    <div class="col-sm-8 col-9 text-right m-b-20">
        ...
        <a href="{{ route('adm-master-input-2') }}" class="btn btn btn-primary btn-rounded float-right"><i class="fa fa-list"></i> Daftar Input</a>
    </div>
</div>
<div class="row">
...
<div class="row">
    <div class="col-lg-12">
        <div class="card-box">
            <form action="{{ route('adm-master-input-2-process') }}" method="POST">
                @csrf
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-10">
                        <input type="text" class="form-control" name="target_condition" >
                    </div>
                </div>
                <div class="form-group row">
