...
<div class="row">
    ...
    <div class="col-sm-8 col-9 text-right m-b-20">
        ...
        <a href="{{ route('adm-master-input-6') }}" class="btn btn btn-primary btn-rounded float-right"><i class="fa fa-list"></i> Daftar Input</a>
    </div>
</div>
<div class="row">
...
<div class="row">
    ...
    <div class="col-lg-12">
        <div class="card-box">
            <form action="{{ route('adm-master-input-6-process') }}" method="POST">
                @csrf
