...
<div class="row">
    ...
    <div class="col-sm-8 col-9 text-right m-b-20">
        <a href="{{ route('adm-master-input-4-par') }}" class="btn btn btn-warning text-white btn-rounded float-right ml-3"><i class="fa fa-gear"></i> Parameter</a>
        <a href="{{ route('adm-master-input-4-add') }}" class="btn btn btn-primary btn-rounded float-right"><i class="fa fa-plus"></i> Tambah Data</a>
    </div>
</div>
<div class="row">
...
<div class="row">
    <div class="col-md-12 col-lg-12 col-sm-12">
        ...
        <div class="form-group row">
            <div class="col-md-2">
                <form action="{{ route('adm-master-input-4') }}" method="GET">
                ...
                <tbody>
                   @foreach ($datamasterinput as $item_list)
                    <tr>
                        ...
                        <td>{{ $item_list->uraian }}</td>
                        <td>{{ $item_list->pasien_id }}</td>
                        <td>{{ number_format($item_list->total_bl,2) }}</td>
                        <td>{{ number_format($item_list->bpjs,2) }}</td>
                        <td>{{ number_format($item_list->tunai,2) }}</td>
                        <td>{{ number_format($item_list->kredit,2) }}</td>
                        {{-- <td><button class="btn btn-success"><i class="fa-sharp fa-solid fa-rotate text-white w-100"></i> </button></td> --}}
                        ...
                        <td class="text-right">
                            ...
                            <div class="dropdown dropdown-action">
                                ...
                                <div class="dropdown-menu dropdown-menu-right">
                                    <a class="dropdown-item" href="{{ route('adm-master-input-4-edit', Enc($item_list->id)) }}"><i class="fa fa-pencil m-r-5"></i> Ubah</a>
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-body text-center">
                ...
                <form action="{{ route('adm-master-input-4-delete') }}" method="POST" >
