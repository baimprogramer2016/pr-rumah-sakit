...
@section('content')
  <div class="row">
      <div class="col-sm-4 col-3">
          <h4 class="page-title">Ubah Petunjuk Teknis</h4>
      </div>
      ...
      <div class="col-md-12 col-lg-12 col-sm-12">
          ...
          @endif
              ...
              <div class="row">
                  <div class="col-sm-12">
                      <div class="card-box">
                          <form action="{{ route('adm-petunjuk-teknis-update', Enc($data_petunjuk_edit->id)) }}" method="POST">
                              @csrf
                                  <div class="form-group">
                                      <select class="select floating" name='input'>
                                          ...
                                          @foreach ($data_list as $item_list)
                                            @if($item_list->route_parent == $data_petunjuk_edit->input)
                                                <option  selected value="{{ $item_list->route_parent }}">{{ $item_list->route_name }}</option>
                                             @else
                              ...
                              <div class="form-group">
                                  <textarea rows="4" cols="5" class="form-control summernote" name="keterangan">{!! $data_petunjuk_edit->keterangan !!}</textarea>
                              </div>
