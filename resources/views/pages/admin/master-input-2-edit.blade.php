...
<div class="row">
    ...
    <div class="col-sm-8 col-9 text-right m-b-20">
        <a href="{{ route('adm-master-input-2') }}" class="btn btn btn-primary btn-rounded float-right"><i class="fa fa-list"></i> Data Input</a>
    </div>
</div>
<div class="row">
...
<div class="row">
    ...
    <div class="col-lg-12">
        <div class="card-box">
            <form action="{{ route('adm-master-input-2-update', Enc($data_edit->id)) }}" method="POST">
                @csrf
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-10">
                        <textarea class="form-control" rows="3" name="key_performance" >{{ $data_edit->key_performance }}</textarea>
                    </div>
                </div>
                <div class="form-group row">
                    <label class="col-form-label col-md-2">Numerator</label>
                    <div class="col-md-10">
                        <textarea class="form-control" rows="3" name="numerator" >{{ $data_edit->numerator }}</textarea>
                    </div>
                </div>
                <div class="form-group row">
                    <label class="col-form-label col-md-2">Denominator</label>
                    <div class="col-md-10">
                        <textarea class="form-control" rows="3" name="denominator" >{{ $data_edit->denominator }}</textarea>
                    </div>
                </div>
                <div class="form-group row">
                    <label class="col-form-label col-md-2">Target Kondisi</label>
                    <div class="col-md-10">
                        <input type="text" class="form-control" name="target_condition" value="{{ $data_edit->target_condition }}">
                    </div>
                </div>
                <div class="form-group row">
                    <label class="col-form-label col-md-2">Target</label>
                    <div class="col-md-10">
                        <input type="text" class="form-control" name="target"  value="{{ $data_edit->target }}">
                    </div>
                </div>
