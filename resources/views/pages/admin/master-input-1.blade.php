...
<div class="row">
    <div class="col-sm-4 col-3">
        <h4 class="page-title">Master Input 1</h4>
    </div>
    <div class="col-sm-8 col-9 text-right m-b-20">
        <a href="{{ route('adm-master-input-1-add') }}" class="btn btn btn-primary btn-rounded float-right"><i class="fa fa-plus"></i> Tambah Data</a>
    </div>
</div>
<div class="row">
...
<div class="row">
    <div class="col-md-12 col-lg-12 col-sm-12">
        ...
        <div class="form-group row">
            <div class="col-md-2">
                <form action="{{ route('adm-master-input-1') }}" method="GET">
                        ...
                        <td class="text-right">
                            ...
                            <div class="dropdown dropdown-action">
                                ...
                                <div class="dropdown-menu dropdown-menu-right">
                                    <a class="dropdown-item" href="{{ route('adm-master-input-1-edit', Enc($item_list->id)) }}"><i class="fa fa-pencil m-r-5"></i> Ubah</a>
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-body text-center">
                ...
                <form action="{{ route('adm-master-input-1-delete') }}" method="POST" >
